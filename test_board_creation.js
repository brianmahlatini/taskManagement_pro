...
async function testBackendBoardCreation() {
  ...
  try {
    ...
    const { createBoard } = require('./backend/src/controllers/boardController');
    ...
    require('./backend/src/controllers/boardController').Board = Board;
    require('./backend/src/controllers/boardController').Team = Team;
